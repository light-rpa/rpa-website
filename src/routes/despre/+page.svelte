...
<section class="relative py-32 bg-rpa-navy text-white overflow-hidden grain grid-pattern">
	...
	<div class="absolute bottom-10 right-20 w-80 h-80 border border-rpa-accent/5 rounded-full"></div>
	<div class="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
		...
		<h1 class="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-fade-in-up delay-100">Despre Noi</h1>
			...
			<div class="reveal">
				<div class="bg-rpa-gray rounded-2xl p-10 border border-gray-100">
					<div class="flex items-center gap-3 mb-10">
						...
						<div>
							<span class="font-heading text-xl font-bold text-rpa-navy">R.P.A.</span>
							<span class="block text-[10px] text-rpa-accent tracking-[0.2em] uppercase -mt-0.5">Robotic Process Automation</span>
						</div>
					</div>

					<div class="grid grid-cols-2 gap-8">
						<div class="relative pl-5 border-l-2 border-rpa-accent/30">
							<div class="font-heading text-4xl font-bold text-rpa-navy">100+</div>
							<div class="text-sm text-gray-500 mt-1">Proiecte Finalizate</div>
						</div>
						<div class="relative pl-5 border-l-2 border-rpa-accent/30">
							<div class="font-heading text-4xl font-bold text-rpa-navy">4+</div>
							<div class="text-sm text-gray-500 mt-1">Industrii Deservite</div>
						</div>
						<div class="relative pl-5 border-l-2 border-rpa-accent/30">
							<div class="font-heading text-4xl font-bold text-rpa-navy">24/7</div>
							<div class="text-sm text-gray-500 mt-1">Suport Tehnic</div>
						</div>
						<div class="relative pl-5 border-l-2 border-rpa-accent/30">
							<div class="font-heading text-4xl font-bold text-rpa-navy">RO</div>
							<div class="text-sm text-gray-500 mt-1">Capital Românesc</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="grid md:grid-cols-3 gap-8">
			{#each values as val, i}
				<div class="reveal bg-white rounded-2xl p-8 border border-gray-100 hover-lift" style="transition-delay: {i * 100}ms">
					...
					<h3 class="font-heading font-bold text-rpa-navy mb-3 text-lg">{val.title}</h3>
		...
		<div class="space-y-6">
			{#each capabilities as cap, i}
				<div class="reveal flex gap-6 items-start bg-rpa-gray rounded-2xl p-8 border border-gray-100 hover-lift" style="transition-delay: {i * 80}ms">
					...
					<div>
						<h3 class="font-heading text-xl font-bold text-rpa-navy mb-2">{cap.title}</h3>
		...
		<div class="grid sm:grid-cols-3 gap-6">
			{#each sickFeatures as feat, i}
				<div class="reveal border border-white/10 rounded-2xl p-8 bg-white/[0.02] backdrop-blur-sm hover-lift" style="transition-delay: {i * 100}ms">
					...
					<h3 class="font-heading font-semibold mb-3 text-lg">{feat.title}</h3>
