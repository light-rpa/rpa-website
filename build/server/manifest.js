...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-D7y7Geah.js')),
			__memo(() => import('./chunks/1-I9z-T26J.js')),
			__memo(() => import('./chunks/2-3WULZbN4.js')),
			__memo(() => import('./chunks/3-DNC9-uJZ.js')),
			__memo(() => import('./chunks/4-BKk6fIVL.js')),
			__memo(() => import('./chunks/5-wNirZ_ya.js')),
			__memo(() => import('./chunks/6-SZMRJVnq.js')),
			__memo(() => import('./chunks/7-BJ4bLrUb.js'))
		],
		remotes: {
